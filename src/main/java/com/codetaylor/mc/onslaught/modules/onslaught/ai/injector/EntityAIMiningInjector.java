...
public class EntityAIMiningInjector
  ...
  public void inject(EntityLiving entity, NBTTagCompound tag) {
    ...
    int range = this.getInteger(aiTag, Tag.AI_PARAM_RANGE, ModuleOnslaughtConfig.CUSTOM_AI_MINING.DEFAULT_RANGE);
    double speedModifier = this.getDouble(aiTag, Tag.AI_PARAM_SPEED_MODIFIER, ModuleOnslaughtConfig.CUSTOM_AI_MINING.DEFAULT_SPEED_MODIFIER);
