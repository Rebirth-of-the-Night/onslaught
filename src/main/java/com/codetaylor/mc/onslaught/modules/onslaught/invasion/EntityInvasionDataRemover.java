...
public class EntityInvasionDataRemover implements Consumer<EntityLiving> {
  ...
  static {
     ...
     */
    entityLiving$persistenceRequired =
        MethodHandleHelper.unreflectSetter(EntityLiving.class, "field_82179_bU");
  }
      ...
      if (entityLiving$persistenceRequired != null) {
        ...
        try {
          ...
          ModOnslaught.LOG.log(
              Level.SEVERE, "Error invoking unreflected setter for field_82179_bU");
