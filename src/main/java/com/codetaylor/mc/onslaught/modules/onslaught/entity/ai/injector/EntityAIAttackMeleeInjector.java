 ...
 */
public class EntityAIAttackMeleeInjector
  ...
  public void inject(EntityLiving entity, NBTTagCompound tag) {
    ...
    if (!(entity instanceof EntityCreature)) {
      ModOnslaught.LOG.log(Level.SEVERE, "EntityAIAttackMelee can only be applied to subclasses of EntityCreature, was " + entity.getClass());
      return;
    }
