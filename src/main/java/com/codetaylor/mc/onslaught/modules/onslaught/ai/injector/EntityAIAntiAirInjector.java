...
import com.codetaylor.mc.onslaught.modules.onslaught.ai.EntityAIAntiAir;
 ...
 */
public class EntityAIAntiAirInjector
  ...
  public void inject(EntityLiving entity, NBTTagCompound tag) {
    ...
    boolean sightRequired = this.getBoolean(aiTag, Tag.AI_PARAM_SIGHT_REQUIRED, ModuleOnslaughtConfig.CUSTOM_AI.ANTI_AIR.DEFAULT_SIGHT_REQUIRED);
    double motionY = this.getDouble(aiTag, Tag.AI_PARAM_MOTION_Y, ModuleOnslaughtConfig.CUSTOM_AI.ANTI_AIR.DEFAULT_MOTION_Y);
